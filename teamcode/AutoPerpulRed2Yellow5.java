...
@Autonomous(name="AutoPerpulPixelYellow5", group = "Demo")

public class AutoPerpulRed2Yellow5 extends LinearOpMode {
    ...
    @Override public void runOpMode() {
        ...
        sleep(1500);
        telemetry.addData("PixelLeft", "turning right to red marker 2");
